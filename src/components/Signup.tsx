...
import { Eye, EyeOff, Mail, Lock, User } from "lucide-react"; // icons

// Validation schema
const signupSchema = z
  .object({
    firstName: z.string().min(1, "Name is required"),
    lastName: z.string(). min(1, "last name rquired"),
  ...
  return (
    <div>
      <div className="space-y-2 mb-6 mt-4">
        <h2 className="text-gray-800 text-2xl font-bold">Create an account with us</h2>
        <p className="text-sm text-gray-500">Become a Part of Our Growing Community</p>
      </div>
