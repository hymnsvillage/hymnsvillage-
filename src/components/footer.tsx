...
const Footer = () => {
  ...
  return (
    <footer
      className="relative text-white px-8 py-12 bg-cover bg-center"
    ...
    >
      ...
      {/* Content Wrapper */}
      <div className="relative z-10 max-w-7xl mx-auto space-y-12 text-center md:text-justify">
        {/* Newsletter Section */}
        <div className="backdrop-blur-[14px] bg-white/5 border border-white/20 rounded-xl p-6 sm:p-10 flex flex-col gap-10 md:flex-row sm:items-center justify-between pl-3">
          <h2 className="capitalize flex-[1] text-xl text-center font-semibold mb-4">
